package com.jhonnyabreu.system.controller;
...
import com.jhonnyabreu.system.exception.RecursoNotFoundException;
import com.jhonnyabreu.system.repository.ClienteRepository;
import com.jhonnyabreu.system.repository.FaturaRepository;
import com.jhonnyabreu.system.repository.InstalacaoRepository;
...
public class FaturaController {
	...
	public List<Fatura> getFaturasPorCPF(@PathVariable String cpf) {
		...
		listaInstalacao.stream().forEach(item -> item.getListaFatura().stream().forEach(fatura -> listaFaturasCliente.add(fatura)));
